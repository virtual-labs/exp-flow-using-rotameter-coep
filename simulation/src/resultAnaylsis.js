...
+'<h2 class="panel panel-primary"> <div class="panel-heading"><center>RESULT ANALYSIS </center></div></h2>'
  ...
  +'          </div>'
   +'   		 <div class="col-sm-6">'
  +'   				 <div class="panel panel-success">'
  +'     					        <div class="panel-heading"><center><h4>BASIC KNOWEDGE</h4></center></div>'
  +'      							<div class="panel-body">'
  +'    									<div class="col-sm-6 border">'
  +'            								    <div class="panel-heading panel-info"><center><h4>Expected </h4></center></div>'
  +'												<h5> <center>6</center></h5>'
  +'               							 </div>'
  +'    									<div class="col-sm-6 border">'
  +'          								   <div class="panel-heading panel-info"><center><h4>Actual </h4></center></div>'
  +'											<h5><center>'+corrans1+'</center></h5>'
  +'           								 </div>'
   +'   							</div>'
  +'  				</div>' 
  +'          </div>'
  ...
  +'          </div>'
   +'   		 <div class="col-sm-6">'
  +'   				 <div class="panel panel-success">'
  +'     					        <div class="panel-heading"><center><h4>INSTANTANEOUS FLOW</h4></center></div>'
  +'      							<div class="panel-body">'
  +'    									<div class="col-sm-6 border">'
  +'            								    <div class="panel-heading panel-info"><center><h4>Expected </h4></center></div>'
